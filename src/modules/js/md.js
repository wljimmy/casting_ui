...
// 导出
export { mdParse, htmlToMd, mdInput, destroyAllEditors, parseMD, autoInitEditors, observeNewEditors };

// 暴露到全局
window.mdParse = mdParse;
window.htmlToMd = htmlToMd;
window.mdInput = mdInput;
window.destroyAllEditors = destroyAllEditors;
window.parseMD = parseMD;
window.autoInitEditors = autoInitEditors;
window.observeNewEditors = observeNewEditors;
